...
const images = [
  ...
  {
    src: 'https://cdn.jsdelivr.net/gh/Ethereumistic/obshtini/carousel/trash.jpg',
...
const ImgCarousel = () => {
  ...
  return (
    <>
<div class="flex items-center flex-wrap justify-around my-5 -mb-28 sm:-mb-28 md:-mb-28 lg:-mb-28 xl:mb-4  xl:-translate-y-12 overflow-hidden sm:overflow-visible md:overflow-visible lg:overflow-visible xl:overflow-visible">
        <div class="flex items-center justify-center w-[800px] h-[800px] bg-transparent scale-[0.49] xl:scale-100 -translate-y-52 sm:-translate-y-48 md:-translate-y-48 lg:-translate-y-44 xl:translate-y-12">
